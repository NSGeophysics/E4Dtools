...
The function \verb+OHM2E4D.m+ will do this for us. In addition, it will return the electrode positions. To use \verb+OHM2E4D.m+ you will need to set the input file,
